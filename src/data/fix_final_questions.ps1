...
# Eliminar la coma extra después de la última pregunta
$content = $content -replace '\},, // Preguntas de Ofimática, Archivo y Redacción \(Primeras 10 de 100\)', '} // Preguntas de Ofimática, Archivo y Redacción (Primeras 10 de 100)'
...
# Ahora, agregar las preguntas de ofimática al final del array
$ofimaticaQuestions = @'
...
# Leer el archivo nuevamente después de la corrección
$content = Get-Content -Path $filePath -Raw

# Insertar las preguntas de ofimática antes del cierre del array
$content = $content -replace '\];', ($ofimaticaQuestions + "`n];")
