# Script para recrear el archivo questions.ts con codificación correcta

# Ruta al archivo questions.ts
$filePath = "c:\Users\ovall\Downloads\test\data\questions.ts"

# Crear el contenido del archivo con codificación UTF-8
$content = @'
// Importar preguntas
...
export const QUESTIONS: Question[] = [
  // Preguntas existentes (vacío por ahora)
];
...
Write-Host "Archivo questions.ts recreado con codificación UTF-8 correcta."
Write-Host "Ahora necesitamos agregar las preguntas de ofimática..."

# Agregar las preguntas de ofimática
...
Write-Host "Preguntas de ofimática agregadas correctamente."
Write-Host "El archivo questions.ts ha sido recreado con éxito con la codificación correcta."
