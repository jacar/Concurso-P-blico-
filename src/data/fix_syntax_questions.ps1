# Script para corregir la sintaxis del archivo questions.ts
...
# Eliminar las líneas que contienen las preguntas de ofimática que causan el error
$content = $content -replace '(?s)// Preguntas de Ofimática, Archivo y Redacción \(Primeras 10 de 100\)\s*\{.*?\}\s*', ''

# Agregar el cierre del array de preguntas
$content = $content.TrimEnd() -replace '\s*$', "`n`n// Preguntas de Ofimática, Archivo y Redacción (Primeras 10 de 100)"
...
# Agregar las preguntas de ofimática al final del archivo
$content = $content + $ofimaticaQuestions
